...
public class ProductMasterStagingServiceImpl implements
	...
	@Override
	public String saveStyleDataToProductMetaData(Map<String, String> productMap)
			throws Exception {
	...
	@Override
	public String updateStyleDataToProductMetaData(
	...
	@Override
	public String saveStyleDataToProductMetaData(String productJson)
			throws Exception {
		return productMasterFeedDao.saveProductMetaDataStyle(productJson);
	}

	@Override
	public String saveColorDataToProductMetadata(Map<String, String> valueMap,
	...
	@Override
	public String saveColorDataToProductMetadata(String colorData,
			String styleNumber) throws Exception {
	...
	@Override
	public String saveSizeDataToProductMetadata(Map<String, String> valueMap,
	...
	@Override
	public String saveSizeDataToProductMetadata(String sizeDataJson,
			String styleNumber, String colorNumber) throws Exception {
	...
	@Override
	public String updateColorDataToProductMetadata(
		...
		int pos = 0;
		if (productMasterFeedDao.findProductByStyleAndColor(styleNumber,
	...
	@Override
	public String updateSizeDataToProductMetadata(Map<String, String> valueMap,
